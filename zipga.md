...
<ol class="clyksb_zipga_list">
    ...
    <li>마지막으로 휴무일을 지정하세요. 일요일과 토욜일같은 정기 휴일을 지정할 수 있고 연차 휴가도 미리 예약 할 수 있어요. 설정을 모두 마치고 시작 버튼을 누르면 앱의 주 기능을 담당하는 메인화면으로 넘어가게 돼요.</li>
</ol><br />
...
<ol class="clyksb_zipga_list">
    <li>알림을 설정할 수 있어요. 출근 시간 설정 알림, 업무 종료 알림 그리고 근무지 근처 알림을 말이죠. 근무 형태가 일반 형일 경우에는 출근 시간 알림 대신 스케줄 확인 알림으로 설정할 수 있어요.</li>
