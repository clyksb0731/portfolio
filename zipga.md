...
<ol class="clyksb_zipga_list">
    ...
    <li style="list-style:none">* 추가로 '오늘 점심시간 무시' 스위치가 있는데 이 스위치를 활성화하면 점심시간동안 근무 시간이 멈추지 않고 형황 뷰에 계산되어 보여져요.</li>
</ol><br />
...
<ul class="clyksb_zipga_list">
    <li>메뉴에서는 근무 내역을 관리할 수 있고 그 것을 기반으로 근무 통계도 볼 수 있죠. 또한 휴가도 관리할 수 있고요. 입사 날짜를 보여주고 경력도 관리할 수 있어요. 마지막으로 메뉴에서는 퇴직 처리를 할 수 있어요.</li>
</ul><br />
...
<ol class="clyksb_zipga_list">
    ...
    <li>선택된 날짜에 대해 일정을 추가하거나 수정할 수 있어요.</li>
</ol><br />
...
<ul class="clyksb_zipga_list">
    <li>근무 통계는 어제까지 근무 내역에 대한 통계예요. 주/월/년에 대한 근무 시간 통계를 확인할 수 있어요.</li>
</ul><br />
...
<ol class="clyksb_zipga_list">
    <li>마지막 근무 날을 선택해서 퇴직 처리를 할 수 있어요. 오늘이거나 오늘보다 늦어지면 퇴직이 예정되고 오늘보다 빠르면 이미 퇴직된 상태가 되죠.</li>
    <li>선택된 마지막 근무일을 변경할 수도 있어요.</li>
    <li>혹은 예정된 퇴직을 취소할 수도 있고요. 마지막 근무 날이 지난 후에는 퇴직을 취소할 수 있어요.</li>
    <li>퇴직 후에는 신규 회사를 설정할 수 있어요.</li>
</ol><br />
...
<ol class="clyksb_zipga_list">
    <li>알림, 근무 형태, 근무지, 연차휴가 그리고 휴무일을 설정할 수 있어요.</li>
    <li>근무 형태에 따라 '출근 시간 설정 알림'이 '스케줄 확인 알림'으로 바뀔 수 있어요.</li>
</ol><br />
...
<ol class="clyksb_zipga_list">
    <li>출근 시간 설정 알림을 설정할 수 있어요. 정기 휴일이 아닌 날에 출근 시간을 설정하라는 알림을 받을 수 있죠. 혹시 근무 형태가 일반형일 경우엔 출근 시간이 고정되어 있어서 해당 알림 대신 그 날 스케줄을 확인하라는 스케줄 확인 알림으로 설정할 수 있어요.</li>
...
<ol class="clyksb_zipga_list">
    ...
    <li>해당 위치를 지도에서 볼 수도 있죠.</li>
    <li>지도를 길게 누르면 해당 위치를 선택하는 팝업 뷰가 나타나요.</li>
</ol><br />
