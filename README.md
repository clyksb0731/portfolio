...
`Swift` `Objective-C` `UIKit` `Storyboard` `AutoLayout` `Realm` `CallKit` `PushKit` `Remote Push` `Alamofire` `AFNetworking` `RESTFult API` `iBeacon` `Rabbit MQ` `Git` `Github` `Bitbucket`
...
**# 개발 정보**
- 개발언어: Objective-C
- 개발스택: UIKit, Storyboard, AutoLayout, AFNetworking, RESTful API, CallKit, PushKit, Remote Push
- 소스관리: Git, Bitbucket
...
**# 개발 정보**
- 개발언어: Objective-C
- 개발스택: UIKit, Storyboard, AutoLayout, AFNetworking, RESTful API, Remote Push
- 소스관리: Git, Bitbucket
...
**# 개발 정보**
- 개발언어: Swift
- 개발스택: UIKit, Storyboard, AutoLayout, Alamofire, RESTful API, Remote Push
- 소스관리: SVN
...
> 티큐리티는 데이터를 분할하여 2곳 이상으로 나누어 보관하고 데이터 사용 시 모든 보안 승인자에게
복원 승인을 수락 받아야 사용이 가능합니다.

**# 앱 설명**
- 포렌식복원이 불가능한 보안
- 정보를 최소단위로 분해
- 원래의 정보로 복원할 수 없도록 함
- 분할된 정보 중 일부분이 없거나 복원 절차가 틀린 경우 복원 불가
- <u style="color:red"><i>앱을 출시하지 않음</i></u> (참고: https://waem.kr/service-grid-with-normal-images)
...
- 이용 내역 관리
- App Store 배포
- <u style="color:red"><i>현재 앱이 정상 동작하지 않음</i></u>
